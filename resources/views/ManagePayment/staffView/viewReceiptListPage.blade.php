                    ...
                    <table class="min-w-full table-auto">
                        ...
                        @foreach ($payments as $payment)
                            <tr class="border-t border-slate-400 bg-gray-100">
                                ...
                                <td class="py-2 px-2">{{ $payment->payment_owed }}</td>
                                ...
                                <td class="py-2 px-2">
                                    <div class="flex space-x-4">
                                        ...
                                        <a href="{{ route('editReceiptPage', $payment->id) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-emerald-400 m-2"
                                        ...
                                        function confirmDeletePayment() {
                                            return confirm('Are you sure you want to delete the Payment?');
                                        }
                                        </script>

                                        <form action="{{ route('delete', $payment->id) }}" method="post">
                                            @csrf
                                            <button type="submit" onclick="return confirmDeletePayment()">
